import { Button, Table, Tag, Modal, Input, InputNumber } from "antd";
...
const DashboardOverview = () => {
    ...
    const dataSource = products.map((product, index) => ({
        key: index,
        productimage: (
            <img src={product.productImage || '/movit.jpg'} alt={product.productName} className="w-[40px]" />
        ),
        productname: <p className="font-roboto cursor-pointer">{product.productName}</p>,
        price: <p className="font-roboto cursor-pointer">{product.productPrice} Rwf</p>,
        quantity: (
            <Tag className="bg-green-500 p-[5px] border-0 cursor-pointer font-roboto font-bold text-white">
                ...
                <div className='grid grid-cols-4 gap-[4px]'>
                    ...
                    <div className='border-solid border-[1px] rounded-[15px] cursor-pointer flex flex-row justify-between p-[20px]'>
                        <div>
                            ...
                            <h4 className='font-roboto font-bold dark:text-white text-[14px] cursor-pointer'>{products.length}</h4>
                        </div>
                        <div>
                    ...
                    <div className='border-solid border-[1px] rounded-[15px] cursor-pointer flex flex-row justify-between p-[20px]'>
                        <div>
                            <p className='font-roboto text-[14px] dark:text-white cursor-pointer'>Total Managers</p>
                    ...
                    <div className='border-solid border-[1px] rounded-[15px] cursor-pointer flex flex-row justify-between p-[20px]'>
                        <div>
                            <p className='font-roboto text-[14px] dark:text-white cursor-pointer'>Total Income</p>
                            <h4 className='font-roboto font-bold dark:text-white text-[14px] cursor-pointer'>230 Rwf</h4>
                        </div>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#000" width="20" height="20">
                                <path d="M15.0049 2.00281C17.214 2.00281 19.0049 3.79367 19.0049 6.00281C19.0049 6.73184 18.8098 7.41532 18.4691 8.00392L23.0049 8.00281V10.0028H21.0049V20.0028C21.0049 20.5551 20.5572 21.0028 20.0049 21.0028H4.00488C3.4526 21.0028 3.00488 20.5551 3.00488 20.0028V10.0028H1.00488V8.00281L5.54065 8.00392C5.19992 7.41532 5.00488 6.73184 5.00488 6.00281C5.00488 3.79367 6.79574 2.00281 9.00488 2.00281C10.2001 2.00281 11.2729 2.52702 12.0058 3.35807C12.7369 2.52702 13.8097 2.00281 15.0049 2.00281ZM11.0049 10.0028H5.00488V19.0028H11.0049V10.0028ZM19.0049 10.0028H13.0049V19.0028H19.0049V10.0028ZM9.00488 4.00281C7.90031 4.00281 7.00488 4.89824 7.00488 6.00281C7.00488 7.05717 7.82076 7.92097 8.85562 7.99732L9.00488 8.00281H11.0049V6.00281C11.0049 5.00116 10.2686 4.1715 9.30766 4.02558L9.15415 4.00829L9.00488 4.00281ZM15.0049 4.00281C13.9505 4.00281 13.0867 4.81869 13.0104 5.85355L13.0049 6.00281V8.00281H15.0049C16.0592 8.00281 16.923 7.18693 16.9994 6.15207L17.0049 6.00281C17.0049 4.89824 16.1095 4.00281 15.0049 4.00281Z"></path>
                    ...
                    <div className='border-solid border-[1px] rounded-[15px] cursor-pointer flex flex-row justify-between p-[20px]'>
                        <div>
                            <p className='font-roboto text-[14px] dark:text-white cursor-pointer'>Total Transactions</p>
                            <h4 className='font-roboto font-bold dark:text-white text-[14px] cursor-pointer'>230</h4>
                        </div>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#000" width="20" height="20">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className='mt-[10px] flex flex-col space-y-[6px]'>
                            <Controller 
                                ...
                                render={({ field }) => (
                                    <Input {...field} placeholder='Product Name' className='pl-[12px] font-roboto pt-[6px] pb-[6px] rounded-[10px] border-solid border-[1px] w-full focus:border-[#000] hover:border-[#000] border-[#000]' />
                                )}
                            />
                            {errors.productName && (
                                <p className='font-roboto text-[12px] text-[#FF204E]'>{errors.productName.message}</p>
                            )}
                            <Controller 
                                name='productPrice'
                                control={control}
                                ...
                                render={({ field }) => (
                                    <InputNumber {...field} placeholder='Product Price' min={0} className='pl-[12px] font-roboto pt-[6px] pb-[6px] rounded-[10px] border-solid border-[1px] w-full focus:border-[#000] hover:border-[#000] border-[#000]' />
                            )}
                            />
                            {errors.productPrice && (
                                <p className='font-roboto text-[12px] text-[#FF204E]'>{errors.productPrice.message}</p>
                            )}
                            <Controller 
                                name='quantity'
                                control={control}
                                ...
                                render={({ field }) => (
                                    <InputNumber {...field} placeholder='Quantity In Stock' min={0} className='pl-[12px] font-roboto pt-[6px] pb-[6px] rounded-[10px] border-solid border-[1px] w-full focus:border-[#000] hover:border-[#000] border-[#000]' />
                                )}
                            />
                            {errors.quantity && (
                                <p className='font-roboto text-[12px] text-[#FF204E]'>{errors.quantity.message}</p>
                            )}
                            {isSubmitting ? 
